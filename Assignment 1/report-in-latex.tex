...
\section{Benchmark Analysis} \label{sec:benchmark}
	\paragraph{} For  this part First, we have to run the benchmark and then capture our desired metric from CloudWatch. So we describe them here.
        ...
        \subsubsection{Clusters}
                \includegraphics[width=\textwidth,height=6cm,keepaspectratio=true]{target response time cluster1 cluster2.png.png}
                    \caption*\small{Target response time of Cluster1 and Cluster2}
                    \label{fig:cpu1}
                \end{figure}
                \includegraphics[width=\textwidth,height=6cm,keepaspectratio=true]{}
                    \caption*\small{of Cluster1 and Cluster2}
                    \label{fig:cpu1}
                \end{figure}
                \includegraphics[width=\textwidth,height=6cm,keepaspectratio=true]{}
                    \caption*\small{of Cluster1 and Cluster2}
