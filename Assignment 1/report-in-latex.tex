...
\section{How to run the code} \label{sec:runcode}
	...
	\begin{itemize}
      ...
      \item sessionToken
    \end{itemize}
    After these attributes have been modified, once you are in the "assignement 1" folder of the git repository, all you have to do is run the "python main.py". It will then create everything you need and install/setup Flask into each instance, alongside the load balancer, the listener and target groups for both cluster. 
